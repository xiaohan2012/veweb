...
from simscore.util.complex import BaseComplex
...
def load_complexes(complex_ids, directory, complex_cls=BaseComplex, residue_cls=BaseResidue):
    """
    load complexes in a row

    >>> from simscore.config import data480_complex_root
